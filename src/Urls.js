...
export const pinCodeToken = 'https://bvcmars.com/RestService/OrderUploadService.svc/GenerateAuthenticationToken'
//pincode 
export const pinCode = 'https://bvcmars.com/bvc_staging/RestService/PincodeMasterService.svc/GetPincodeData'

//track order
export const trackOrder = 'https://bvcmars.com/RestService/TrackingService.svc/GetDocketTrackingDetails'
