                  ...
                  <Accordion.Body>
                    <div className={Classes.faqTextContainer}>
                      <span className={Classes.Answer}>
                        {" "}
                        You’re welcome to browse swadiamonds.com any time
                        without an account. Once you decide to place an order,
                        you’ll need to set up an account to provide us with the
                        details needed to process your order. With an account
                        you can enjoy a personalized shopping experience,
                        including recommendations, quicker checkout, and a
                        shareable wish list.
                      </span>

                      <span className={Classes.Answer}>
                        1. I need to make some changes; can I edit the details
                        of my account and/or change address, name and password?
                        Of course you can. Log-in to your account and you can do
                        most edits yourself except things like Email ID which
                        requires you to contact the Customer Service Team
                      </span>
                ...
                <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                    <div className={Classes.faqTextContainer}>
                      ...
                      <span className={Classes.Answer}>
                        2. I need to make some changes; can I edit the details
                        of my account and/or change address, name and password?
                        Of course you can. Log-in to your account and you can do
                        most edits yourself except things like Email ID which
                        requires you to contact the Customer Service Team
