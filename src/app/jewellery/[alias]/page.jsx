...
export const generateMetadata = async ({ params }) => {
  ...
  const response = await fetch(
    `https://swaprdnecomnewdemo.zinfog.in/ecom/alias-product/?alias=${productAlias}&country=${countryId}`,
    {
      headers: {
  ...
  return {
    ...
    openGraph: {
      title: productDetails.meta_title,
      description: productDetails.meta_description,
      url: "https://swa-ecom-demo-project.vercel.app/jewellery/" + productDetails.alias,
