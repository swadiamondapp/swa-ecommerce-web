...
function Swapromise() {
 ...
 const data = [
    {
       title: "personalised video consultaion",
    ...
    {
      title: "400+ Store across india & uae",
      description: "400+ Store across india & uae",
      image: "/try/store_across_india_uae.svg",
    },
    {
      title: "Free shipping",
      ...
      <div className="max-w-container h-full mx-auto justify-between px-4 gap-10 items-center lg:items-stretch flex flex-col-reverse lg:flex-row">
        <div className="flex flex-col justify-center relative">
          <div className="hidden lg:block text-start lg:mb-[4rem]">
            <p className="text-[56px] font-playfair font-[500] min-w-[430px]">
              swa promise
            </p>
          ...
          <div className="md:hidden flex flex-col items-center gap-6 w-full">
            ...
            <div className="flex justify-around sm:gap-[2rem] w-full">
              {data.slice(0, 3).map((item, index) => (
                <div
                  className="text-center flex flex-col items-center w-[100px]"
                  key={index}
                >
                  <div className="w-[90px] h-[90px] md:w-[100px] md:h-[100px] mb-[.5rem] flex items-center justify-center">
                    <img
                      src={item.image}
                      alt={item.title}
            ...
            <div className="flex justify-between w-full">
              {data.slice(3, 6).map((item, index) => (
                <div
                  ...
                  key={index + 3}
                >
                  <div className="w-[90px] h-[90px] md:w-[100px] md:h-[100px]  mb-2 flex items-center justify-center">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="w-[36px] h-[36px] md:w-[48px] md:h-[48px]"
