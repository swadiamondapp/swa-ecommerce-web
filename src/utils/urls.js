...
//metalCategory
export const metalCategoryUrl = server + "ecom/metal_types/";

//filterCatgories
export const categoryWiseUrl = server + "ecom/categories";
...
export const outlets = server + "ecom/outlet-details/";
