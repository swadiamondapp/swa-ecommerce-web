  ...
  return (
    <div className="w-full h-[43rem] bg-[#F8F4E9] lg:h-[67.5rem] md:h-[67.5rem] sm:h-[43rem] ">
      <div className="max-w-container mx-auto h-full relative">
        <div className="hidden lg:flex w-[23.61rem] h-[10.04rem] justify-between left-[0.53rem] top-[50.89rem] absolute lg:w-[23.61rem] lg:h-[10.04rem] lg:left-[0.53rem] lg:top-[50.89rem] md:w-[23.61rem] md:h-[10.04rem] md:left-[0.53rem] md:top-[50.89rem] sm:w-[23.61rem] sm:h-[10.04rem] sm:left-[0.53rem] sm:top-[50.89rem]">
          <div>
            <Image
        ...
        <Image
          ...
          className="absolute  bottom-0 left-1/2 transform -translate-x-1/2 lg:pl-8 w-[20rem] h-[19.34rem] sm:w-[20rem] sm:h-[19.34rem] md:w-[40rem] md:h-[40rem] lg:w-[53.35rem] lg:h-[52.6rem] "
        ...
        <div className="absolute text-center flex flex-col items-center left-1/2 transform -translate-x-1/2 lg:block lg:text-left top-[1.687rem] w-[20.125rem] md:w-[24rem] lg:top-[8.4rem] lg:left-[12.51rem] md:top-[3.9rem] sm:top-[6.4rem] ">
          ...
          <p className="pb-[1.55rem] lg:pb-[1.55rem] md:pb-[1.55rem] sm:pb-[1.55rem] md:max-w-[23.60rem] max-w-[20rem] text-[0.75rem]">
            Its design draws inspiration from the  pink oyster  mushroom,
            a symbol of immortality and longevity, and it  features 41
        ...
        <div className="hidden lg:block w-[16.91rem] text-end absolute top-[9.13rem] right-[0.53rem] lg:w-[16.91rem] lg:top-[9.13rem] lg:right-[0.53rem] md:w-[16.91rem] md:top-[9.13rem] md:right-[0.53rem] sm:w-[16.91rem] sm:top-[9.13rem] sm:right-[0.53rem]">
          ...
          <div className="hidden lg:block absolute text-end top-[55.91rem] left-[85.21rem] w-[15.32rem] h-[5.25rem] lg:top-[55.91rem] lg:left-[85.21rem] lg:w-[15.32rem] lg:h-[5.25rem] md:top-[55.91rem] md:left-[85.21rem] md:w-[15.32rem] md:h-[5.25rem] sm:top-[55.91rem] sm:left-[85.21rem] sm:w-[15.32rem] sm:h-[5.25rem]">
