...
const ProductDetails = (props) => {
  ...
  const customerPhotos = async () => {
    const response = await axios.get(
      "https://swaprdnecomnewdemo.zinfog.in/ecom/products/" + props.id + "/reviews/"
    );
              ...
              <div className={Classes.ParentHeadingD1}>
                ...
                >
                  ...
                  <RWebShare
                    data={{
                      text: "Swa Diamonds",
                      // url: "https://swa-ecom-demo-project.vercel.app/" + location.pathname,
                      // url: `https://swa-ecom-demo-project.vercel.app/jewellery/share?id=${props.productDetails.id}&color=${props.productDetails.color}&name=${props.productDetails.name}&alias=${props.alias}`,
                      url: `https://swa-ecom-demo-project.vercel.app/jewellery/share?id=${
