...
const LoginModal = (props) => {
  ...
  return (
    <>
      ...
      {userName ? (
        <div className={Classes.LogedUser} style={{ cursor: "pointer" }}  ref={nameRef} onClick={handleLogedUserClick}>
      ...
      {showUserDetails && (
        <div ref={userDetailsRef} className={Classes.LogedUserDetails}>
          ...
          <div className={Classes.LogedDetails_list}>
            ...
            <Link to="" style={{ fontSize: "16px" }}  className={Classes.LogedDetails_Item}>
              <p style={{ fontSize: "16px" }}>Swa exchange</p>
            </Link>

            <p style={{ cursor: "pointer",width:'100%' }} onClick={handleLogOut} className={Classes.ListPTag} >
              Log Out
            </p>
          </div>
        </div>
