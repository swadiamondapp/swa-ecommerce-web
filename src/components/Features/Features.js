        ...
        <div className={Classes.FeaturesBg}>
            ...
            <div className={Classes.MarginFeatures}>
                <div className='row'>
                    ...
                    <div className={`${'col-sm-6'} ${'col-md-3'} ${Classes.FeaturesDetails} ${Classes.Shipping}`}>
                    ...
                    <div className={`${'col-sm-6'}  ${'col-md-3'} ${Classes.FeaturesDetails} ${Classes.MoneyBack}`}>
                    ...
                    <div className={`${'col-sm-6'}  ${'col-md-3'} ${Classes.FeaturesDetails}`}>
                    ...
                    <div className={`${'col-sm-6'}  ${'col-md-3'} ${Classes.FeaturesDetails} ${Classes.Security}`}>
