...
<div className="max-sm:overflow-x-auto max-sm:overflow-y-visible max-sm:w-full max-sm:h-fit">
  <div className="h-fit w-full flex flex-row justify-between lg:ml-9 md:ml-0 md:mr-0 sm:ml-0 sm:mr-0 ml-2 mr-2 lg:mt-[4rem] mt-[2rem] lg:mb-0 mb-[2rem] z-20 max-md:justify-start max-md:gap-4 max-sm:w-fit">
    {data.map((data) => (
