...
function Header() {
  ...
  return (
    <>
      ...
      {/* Left Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-80 bg-white z-[9900] transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="p-[1rem]">
          ...
          <div className="space-y-4">
            ...
            <h3 className="font-medium text-gray-700 border-b pb-2 mt-6">
              Tags
            </h3>
            {tags?.map((tag, index) => (
              <div key={index}>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  {pincode ? (
                    <div className="flex items-center space-x-2">
                      <span className="text-xs text-[#017480] font-medium">
                        {pincode}
                      </span>
                      <FaPen className="text-xs text-[#017480]" />
                    </div>
                  ) : (
                    <p className="text-xs text-[#017480] font-medium">
                      Enter PinCode
                    </p>
                  )}
                </div>
